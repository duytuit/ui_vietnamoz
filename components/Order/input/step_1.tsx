...
const Step1=({ formStep,setNewCustomer, nextFormStep ,product ,customer,register}) =>{
  ...
  return (
    <>
      <Form ref={formRef} onSubmit={handleSubmit}>
        <div
          className={`start-modal-wr ${formStep === 0 ? "block" : "hidden"}`}
        >
                ...
                <div className="ng-scroll-offset ng-scroll-viewport">
                  <div className="ng-scroll-content">
                    <div className="modal-wr-mobile">
                      <h1 className="bp-h1 text-black dark:text-white">
                      ...
                      <div className="modal-disclamer">
                        ...
                        <div className="checkbox-container">
                          ...
                          <label
                            className="label_disclamer_1 pl-9"
                            onClick={handleCheckDisclamer_1}
                            htmlFor="disclamer-1"
                          >
                        ...
                        <div className="checkbox-container">
                          ...
                          <label
                            className="label_disclamer_2 pl-9"
                            onClick={handleCheckDisclamer_2}
                            htmlFor="disclamer-2"
                          >
