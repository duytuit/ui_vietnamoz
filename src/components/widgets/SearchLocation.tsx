...
const SearchLocation = () => {
    ...
    return (
        <>
        <AsyncSelect cacheOptions isClearable loadOptions={loadOptions} defaultOptions components={{ DropdownIndicator: CaretDownIcon }} placeholder={"Enter your nationality to begin"} styles={customStyles}/>
        </>
    );
    }
